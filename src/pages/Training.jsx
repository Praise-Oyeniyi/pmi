    ...
    <div className='w-full h-full font-aeonik bg-white text-dark overflow-x-hidden'>
        ...
        <div className='w-full bg-white'>
            <Hero
                ...
                url={"<a href='/' className='hover:underline'>Home</a> / Training"}
            ...
            <main className="about-main-header pt-10 ">
                <div className="main-inner hide-bar  overflow-x-auto min-full text-purple-light font-normal text-sm md:text-2xl gap-x-7 flex md:gap-x-12 justify-center border-b border-b-[#DBD8D1] cursor-pointer">
