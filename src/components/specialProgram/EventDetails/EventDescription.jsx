        ...
        <div className='mx-auto w-[90%] md:w-5/6 space-y-7'>
            <div className="description w-full">
                ...
                <div className='md:flex items-stretch gap-x-7 justify-between w-full'> 
                    ...
                    <div className='bg-white rounded-3xl mt-7 md:mt-0 p-3 md:p-5 md:px-7 border border-[#E8E8E8]'>
                        <h4 className='text-xl md:text-xl font-bold pb-2 border-b  border-b-[#DADADA]'>Description</h4>
                        <div className='text-sm md:text-lg font-normal pt-3 space-y-2 list-disc'>{desc}</div>
                    </div>
                </div>
            </div>

            <div>
                <h4 className='text-xl md:text-xl font-bold pb-2'>
                    {audTitle}
                </h4>
            ...
            <div className="speaker">
                ...
                {keyExpPoints !== [] || profCert !== [] && 
                    ...
                    <h4 className='text-lg md:text-xl font-semibold md:pb-2 '>{keyExpTitle}:</h4>
                    <div className='pt-2'>
                        <ul className='md:flex justify-between list-disc text-[#3A2B51] text-sm md:text-lg font-normal'>
                            ...
                            <div className='w-full md:w-3/6 md:pl-10 md:-mt-1 pt-3 md:pt-0'>
                                <h4 className='text-[#040301] text-lg md:text-xl font-semibold md:w-full w-3/6 pb-3 md:pb-1 leading-tight'>{profCertTitle}:</h4>
