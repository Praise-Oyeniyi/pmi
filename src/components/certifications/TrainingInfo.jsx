  ...
  return (
    <div className='w-full text-dark'>
        <div className="mx-auto w-[90%] md:w-5/6 my-10 py-10 space-y-14">
            ...
            <div className={`overflow-x-hidden rounded-3xl ${dates && dates.length !== 0 && 'border border-[#BFBFBF]'}`}>
            ...
            <div className='why-pmp'>
                <div className="description w-full">
                    <div className='md:flex items-center gap-x-5 justify-between w-full'> 
                        <div className="image overflow-hidden w-full md:w-3/6 md:h-[21rem] rounded-2xl">
                            <img src={whyImage?.url} alt={whyImage?.alt} className='h-full w-full object-cover object-center'/>
                        </div>
                        <div className='w-full md:w-3/6 py-5 md:p-5 md:px-7'>
                            ...
                            <p className='pl-2 text-sm md:text-lg text-justify  text-[#3A2B51] space-y-2 md:space-y-1 pt-1'>
                                {whyDesc}
                            </p>
