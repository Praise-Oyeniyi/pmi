    ...
    <div className='md:flex items-center gap-x-10'>
        ...
        <div className='flex flex-col justify-between  gap-y-5 md:gap-y-12 h-full py-5 md:py-0'>
            <div className='md:space-y-2'>
                <h3 className='text-xl md:text-3xl font-bold'>Krishnesh nair</h3>
                <h5 className='capitalize text-base md:text-xl font-medium'>membership number: <span className='font-semibold'>123456789</span> </h5>
            </div>
