...
const FaqBanner = () => {
  return (
    <div className='w-full md:my-20 mt-20'>
        <div className="faq-inner mx-auto w-5/6 bg-gradient-to-b from-[#097C9E] to-[#CDB7A6] rounded-3xl md:rounded-4xl md:px-7 p-5 md:py-10">
            <div className='w-full md:flex justify-between items-center space-y-7 md:space-y-0'>
