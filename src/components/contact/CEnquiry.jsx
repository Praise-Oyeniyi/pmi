  ...
  return (
    <div className='w-full'>
        <div className="w-3/6 mx-auto pt-5">
            <h4 className='font-bold text-3xl'>Corporate (Bulk Training) Enquiry </h4>
            ...
            <form action="#" onSubmit={(e)=>cEnquire(e)} className="py-5 w-full space-y-5">
                ...
                <div className="training-subj">
                    <label htmlFor="training-subj" className=' text-xl font-normal text-[#6B5E64] block capitalize mb-1'>Training Subjects</label>
                ...
                <div className='w-full flex gap-x-5 items-end'>
                    <div className="date-input w-2/6">
                        <label htmlFor="date" className=' text-xl font-normal text-[#6B5E64] block mb-1'>Preferred training date</label>
