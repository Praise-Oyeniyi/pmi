    ...
    <div>
        <div className='w-full'>
            <div className='w-[90%] md:w-5/6 mx-auto border-b border-b-[#DBD8D1] pb-7' id='inner'>
                <h3 className='font-bold text-2xl md:text-4xl leading-snug text-center pb-3 capitalize '>Inner Circle</h3>
                
                <div className='text-sm md:text-lg text-[#200F3B] space-y-7'>
                    <p>
                    ...
                    <div className='space-y-3'>
                        <h5 className='text-purple font-semibold text-lg'>Inner Circle Benefits</h5>
