        ...
        <div className='w-[90%] md:w-5/6 mx-auto pb-14 border-b border-b-[#DBD8D1]'>
            ...
            <div className='space-y-5'>
                <div className='md:space-y-3 space-y-1'>
                    ...
                    <p className='text-sm md:text-xl font-normal text-[#200F3B] w-5/6'>In the form of providing SMEs from the industry as external speaker for in house events 
                ...
                <div className='md:space-y-3 space-y-1'>
                    ...
                    <ul className='text-sm md:text-xl font-normal text-[#200F3B] space-y-3 list-disc pl-7 w-5/6'>
